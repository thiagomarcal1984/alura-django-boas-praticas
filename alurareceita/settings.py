...
caminho = os.path.join(PROJECT_ROOT, '../apps')
print(caminho) # D:\django-boas-praticas\alurareceita\../apps
sys.path.insert(0, caminho) # Insere PROJECT_ROOT no path do projeto Django.
